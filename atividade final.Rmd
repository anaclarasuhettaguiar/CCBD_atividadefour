...
Para elaborar o histograma utilizaremos o pacote ggplot2 com a função geom_histogram

``` {r,fig.align = "center" }

world=data.frame(value=rnorm(100))
p <- ggplot(world, aes(x=decimalLatitude, y=depth)) + 
  geom_histogram()
p
```
